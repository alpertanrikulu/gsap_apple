    ...
    useGSAP(() => {
        if(!isTablet) {
            const timeline = gsap.timeline({
             ...
             // it points the img which belongs to the div with "mask" class
  ...
  return (
    <section id='showcase'>
        <div className='media'>
            ...
            <div className='mask'>
                <img src="/mask-logo.svg" alt="asdf" />
            </div>
        </div>
            ...
            <div className='wrapper'>
                <div className='lg:max-w-md'>
                    ...
                    <div className='space-y-5 mt-7 pe-10'>
                        <p>
                            Introducing {" "}
                            <span className='text-white'>M4, the next generation Apple slicon</span>
                            .M4 powers
                        </p>
                        <p>
